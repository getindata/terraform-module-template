...
| <a name="input_descriptor_name"></a> [descriptor\_name](#input\_descriptor\_name) | Name of the descriptor used to form a resource name | `string` | `"reseource-type"` | no |
...
| <a name="input_sub_resource"></a> [sub\_resource](#input\_sub\_resource) | Some other resource that is part of stack/module | <pre>object({<br>    descriptor_name = optional(string, "sub-reseource-type")<br>    example_var     = string<br>  })</pre> | n/a | yes |
